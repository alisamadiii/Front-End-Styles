...
export default function Producer({}: Props) {
  return (
    <motion.a
      ...
      target="_blank"
      className="fixed right-0 flex items-center gap-4 px-4 py-2 pr-12 text-black bg-white rounded-l-full top-4 hover:bg-[#00acee] hover:text-white duration-200"
    >
      <Image
